...
#define icopy(n, a, b) (idxtype *)memcpy((void *)(b), (void *)(a), sizeof(int)*(n)) 
#define dcopy(n, a, b) (double *)memcpy((void *)(b), (void *)(a), sizeof(double)*(n)) 
...
#define dmalloc(n, msg) (malloc(sizeof(double)*(n)))
...
#define dsmalloc(n, val, msg) (dset((n), (val), malloc(sizeof(double)*(n))))
#define GKmalloc(a, b) (malloc((a)))
#endif

#ifdef DMALLOC
#   define MALLOC_CHECK(ptr)                                          \
    if (malloc_verify((ptr)) == MALLOC_VERIFY_ERROR) {  \
