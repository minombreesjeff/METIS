 ...
 * George
 *
 * $Id: mfm.c,v 1.2 2002/08/10 06:29:33 karypis Exp $
 */
...
**************************************************************************/
void MocFM_2WayEdgeRefine(CtrlType *ctrl, GraphType *graph, float *tpwgts, idxtype npasses)
{
...
**************************************************************************/ 
void SelectQueue(idxtype ncon, float *npwgts, float *tpwgts, idxtype *from, idxtype *cnum, PQueueType queues[MAXNCON][2])
{
  idxtype i, part, maxgain=0;
...
**************************************************************************/ 
idxtype BetterBalance(idxtype ncon, float *npwgts, float *tpwgts, float *diff)
{
  idxtype i;
  float ndiff[MAXNCON];
...
**************************************************************************/ 
float Compute2WayHLoadImbalance(idxtype ncon, float *npwgts, float *tpwgts)
{
  idxtype i;
  float max=0.0, temp;
...
**************************************************************************/ 
void Compute2WayHLoadImbalanceVec(idxtype ncon, float *npwgts, float *tpwgts, float *lbvec)
{
  idxtype i;
