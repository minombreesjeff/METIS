...
static void iiqst(idxtype *, idxtype *);
...
**************************************************************************/
void iidxsort(idxtype n, idxtype *base)
{
  register idxtype *i;
  register idxtype *j;
  register idxtype *lo;
...
* Entry point of idxtype increasing sort
**************************************************************************/
void iintsort(idxtype n, idxtype *base)
{
  register idxtype *i;
  register idxtype *j;
  register idxtype *lo;
...
static void iiqst(idxtype *base, idxtype *max)
{
  register idxtype *i;
  register idxtype *j;
  register idxtype *jj;
...
**************************************************************************/
void ikeysort(idxtype n, KeyValueType *base)
{
...
**************************************************************************/
void ikeyvalsort(idxtype n, KeyValueType *base)
{
  register KeyValueType *i;
  register KeyValueType *j;
  register KeyValueType *lo;
