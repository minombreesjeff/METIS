 ...
 * kwtest.c
 *
 * This file contains code for testing METIS_W and KWMETIS routines
 *
 * Started 9/15/97
 * George
 *
 * $Id: kwtest.c,v 1.1 1997/11/04 23:19:50 karypis Exp $
 *
 */
...
main(int argc, char *argv[])
{
  ...
  options[0] = 0;
  METIS_WPartGraphKway(&graph.nvtxs, graph.xadj, graph.adjncy, graph.vwgt, graph.adjwgt, &wgtflag, &numflag, &nparts, tpwgts, options, &edgecut, part);
